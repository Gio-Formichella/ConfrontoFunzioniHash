...
# remove plot
div_inspected = pickle.load(open("results/removal/div_inspected_dim=2048.p", "rb"))
mul_inspected = pickle.load(open("results/removal/mul_inspected_dim=2048.p", "rb"))
x1 = list(div_inspected.keys())
y1 = list(div_inspected.values())
x2 = list(mul_inspected.keys())
y2 = list(mul_inspected.values())
...
div_inspected = pickle.load(open("results/removal/div_inspected_dim=2053.p", "rb"))
mul_inspected = pickle.load(open("results/removal/mul_inspected_dim=2053.p", "rb"))
x1 = list(div_inspected.keys())
y1 = list(div_inspected.values())
x2 = list(mul_inspected.keys())
y2 = list(mul_inspected.values())
